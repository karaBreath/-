...
_QUANTITY_UNIT_WORDS = (
    ...
    "กิโลกรัม", "กรัม", "กก.", "ขีด", "ตัน",
    "มิลลิเมตร", "เซนติเมตร", "ซม.", "กิโลเมตร", "กม.", "เมตร", "ม.",
    "ไมล์", "นิ้ว", "ฟุต", "วา", "ไร่", "งาน",
    "ตารางเมตร", "ตร.ม.", "ลูกบาศก์เมตร", "ลิตร", "มิลลิลิตร", "ซีซี",
    "วินาที", "นาที", "ชั่วโมง", "ชม.", "สัปดาห์", "เดือน",
    "องศา", "เปอร์เซ็นต์", "%",
    "คน", "ครั้ง", "ชิ้น", "เล่ม", "แผ่น", "กล่อง", "ถุง", "ขวด", "แก้ว",
    "จาน", "คัน", "หลัง", "ล้าน", "แสน", "หมื่น", "พัน", "ดาว", "คะแนน",
    "ที่", "ห้อง", "ตัว", "ใบ", "อัน", "เท่า", "ปี", "วัน", "ระดับ",
)

# หน่วยจริงต้องจบตรงนั้น ไม่ใช่เป็นพยางค์แรกของคำอื่น
#
# ภาษาไทยไม่เว้นวรรคระหว่างคำ "ห้อง 2105 คนนี้" จึงมี "คน" ตามหลังตัวเลข
# ทั้งที่คำจริงคือ "คนนี้" ซึ่งไม่ใช่ลักษณนาม เลขห้องเลยถูกอ่านเป็นจำนวน
# ยอมให้ตามด้วยคำลงท้ายได้ เพราะคนไทยเขียน "ห้าร้อยกรัมครับ" ติดกันเป็นปกติ
_QUANTITY_UNIT = re.compile(
    r"^\s*(?:"
    + "|".join(re.escape(w) for w in sorted(_QUANTITY_UNIT_WORDS, key=len, reverse=True))
